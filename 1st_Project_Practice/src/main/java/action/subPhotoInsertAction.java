...
public class subPhotoInsertAction extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		int maxSize = 1024 * 1024 * 100; // 최대 업로드 크기 (100MB)
        ...
        subPhotoVo vo = new subPhotoVo(sub_p_title, sub_p_category, sub_p_min_player, sub_p_max_player, sub_p_playtime, sub_p_age, sub_p_year, sub_p_publisher, sub_p_filename, sub_p_detail_loc);
