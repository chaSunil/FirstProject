	...
	create table items(
		...
		item_image varchar2(100) not null,	-- 이미지경로
	...
	alter table items
		add constraint ck_item_o7_val check(item_o3_val between 80 and 100);
	...
	alter table items
		add constraint fk_items_item_o3 foreign key(option3_idx)
										references options3(option3_idx)
	
	-- foreign key delete
	alter table items drop constraint fk_items_item_o1
	
	-- items view 생성
	create or replace view items1_item_o1_view
	as
	select
		i.*,go1.gibon_option1_name 기본옵션명1, go2.gibon_option2_name 기본옵션명2, go3.gibon_option3_name 기본옵션명3,
		go4.gibon_option4_name 기본옵션명4, go5.gibon_option5_name 기본옵션명5, go6.gibon_option6_name 기본옵션명6,
		go7.gibon_option7_name 기본옵션명7,
		o1.item_o1 옵션명1, o2.item_o2 옵션명2, o3.item_o3 옵션명3,
		o4.item_o4 옵션명4, o5.item_o5 옵션명5, o6.item_o6 옵션명6, o7.item_o7 옵션명7
	...
	create sequence seq_items3_item_idx
	...
	create table items4(
		...
		gibon_option2_val	int,		
		gibon_option3		int,			-- 기본내구도
		gibon_option3_val	int,		
		gibon_option4		int,			-- 기본필요민첩
		gibon_option4_val	int,
		gibon_option5		int,			-- 기본필요힘
		gibon_option5_val	int,
		gibon_option6		int,			-- 요구레벨
		gibon_option6_val	int,
		gibon_option7		int,			-- 기본 공격속도
		gibon_option7_val	int,
	...
	create sequence seq_items4_item_idx
							
	insert into items4 values(
								seq_items_item_idx.nextVal,
								'키네밀의 송곳 자이언트 소드',
								'../resources/weapon01.jpg',
								'양손검',
								'익셉셔널',
								'유니크',
								'수리가능',0,
